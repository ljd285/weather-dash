...
fiable buscarlo tú mismo en la web de AEMET y fijarlo aquí, como se hace
abajo, porque la búsqueda automática puede coger una estación homónima
equivocada).

El campo 'municipio' es el código INE de 5 dígitos que usa AEMET para la
predicción por municipios — OJO: es un código de MUNICIPIO, no de estación
climatológica, y ambos pueden ser muy distintos para una misma localidad
(p. ej. el Aeropuerto de Valencia está físicamente en el municipio de
...
STATIONS = [
    {
        ...
        "busqueda_nombre": "VALENCIA",  # solo se usaría si se borra el idema de arriba
